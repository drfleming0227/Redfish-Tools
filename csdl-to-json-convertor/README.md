    ...
    <table>
      <thead>
        <tr>
          ...
          <th align="left" valign="top">CSDL&#8209;to&#8209;JSON&nbsp;converter&nbsp;creates&nbsp;JSON&nbsp;file&nbsp;or&nbsp;files</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          ...
          <td align="left" valign="top">Unversioned file that uses <code>anyOf</code> statement to point to all file versions</td>
        </tr>
        <tr>
          <td align="left" valign="top"><code>EntityType</code> element</td>
          <td align="left" valign="top">In unversioned namespace that is not marked abstract</td>
          <td align="left" valign="top">Unversioned file</td>
        </tr>
        <tr>
          <td align="left" valign="top"><code>EntityType</code> element </td>
          <td align="left" valign="top">In versioned namespace</td>
          <td align="left" valign="top">Current and newer file versions</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="left" valign="top">All file versions</td>
        </tr>
        <tr>
          <td align="left" valign="top"><code>Action</code> property</td>
          <td align="left" valign="top">In versioned namespace</td>

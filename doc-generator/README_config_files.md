...
| `omit_version_in_headers`<br/><br/>**Equivalent&nbsp;command&#8209;line&nbsp;argument:** None | Boolean | No default. <p>Value is:</p><ul><li><code>true</code>. Exclude schema versions from clause headers.</li><li><code>false</code>. Include schema versions in clause headers.</li></ul> |

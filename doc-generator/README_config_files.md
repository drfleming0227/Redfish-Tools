...
| :-------------------------------------------- | :--- | :------------------------------------------------ |
| `actions_in_property_table`<br/><br/>**Equivalent command-line argument:** None | Boolean | Default is `true`.<ul><li><code>true</code>. Include <code>Actions</code> in the property tables.</li><li><code>false</code>. Suppress <code>Actions</code> from the property tables.</li></ul> |
